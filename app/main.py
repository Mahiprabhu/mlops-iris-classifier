...
try:
    # loads the model object from the MLflow model registry.
...
# FastAPI to validate input automatically.
...
def predict(features: IrisFeatures):
    ...
    # Convert the Pydantic object into a format our model expects (a list of lists)
    input_data = [[
    ...
    try:
        ...
        # Map the numeric prediction (0, 1, 2) to the actual flower names
...
if __name__ == "__main__":
    # This allows us to run the API locally for testing.
